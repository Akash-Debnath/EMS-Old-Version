...
<div id="myTabContent" class="tab-content">
    ...
    <div class="tab-pane fade active in" id="same">
        <br>
        <form action="<?php echo base_url()?>roster_new/save" method="post"
                    ...
                    <div class='form-group'>
                        ...
                        <div class='col-sm-3'>
                            <input type='submit' name='save' id='save_same'
                                   value="Save Changes" class='btn btn-info'>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="tab-pane fade" id="custom">
        ...
        <form id="CustomformId" action="<?php echo base_url()?>roster_new/save" method='post'>
...
<div class="modal fade" id="requestModal" role="dialog"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form id='reqWeekendForm' class='form-horizontal' action="<?php echo base_url()?>roster_new/officeTimeSetup" method="post">
...
<script>
    ...
    $(function() {
        ...
        $('#sendRequest').on('click', function(){
            ...
            var url = "<?php echo base_url()?>roster_new/save";
            $.ajax({
                type: "POST",
                url: url,
