...
class G_Controller extends CI_Controller{
    ...
    public  $web_url = "http://staff.genuitysystems.com/ems/";
    public  $web_url_main = "http://staff.genuitysystems.com/";
    
    //public  $web_url = "http://localhost/ems/";
    
    public $flexible_office_times = array('regular'=> '00:00:59', '09:00:00' => '00:15:00', );
	...
	public function getTotalUpdateRequestCount() {
	    $query = "SELECT count(id) as total FROM employee_edit WHERE status = 'N'";
	    $result = $this->db->query($query);
	    $result = $result->row_array();
